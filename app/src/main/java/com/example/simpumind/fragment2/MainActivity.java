...
public  class MainActivity extends ActionBarActivity
    ...
    private InputStream downloadUrl(final java.net.URL url) throws IOException {
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public class DOAsyncTask extends AsyncTask<Void, Void, Void> {
            ...
            protected Void doInBackground(Void... params) {
                ...
                /* Note to Hafees use this to retrieve xml stream  from server*/
                // stream =downloadUrl(URL);
                /* this is to retrieve it locally from asset folder n res*/
                Context context=getActivity().getApplicationContext();
                try {
                    stream = context.getAssets().open("xml/soccer_livescore.xml");
                    GoalServer parser=new GoalServer();
                    categories=parser.parse(stream);
                } catch (IOException e) {
                    e.printStackTrace();
            ...
            protected void onPostExecute(Void aVoid) {
                ...
                Toast.makeText(getActivity(),"Value got " + categories.get(0).name,Toast.LENGTH_LONG).show();

                /* values you can get xml parse */
                //List<Category> categories
                // from each category get match list
                //List<Matches> matches=category.getMatches()
                //fromeach matches get localTeam and VisitorTeam
